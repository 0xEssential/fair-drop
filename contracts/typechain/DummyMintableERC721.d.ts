...
interface DummyMintableERC721Interface extends ethers.utils.Interface {
  functions: {
...
export class DummyMintableERC721 extends Contract {
  ...
  interface: DummyMintableERC721Interface;
