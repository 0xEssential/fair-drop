...
interface ERC1155PredicateProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155PredicateProxy extends Contract {
  ...
  interface: ERC1155PredicateProxyInterface;
