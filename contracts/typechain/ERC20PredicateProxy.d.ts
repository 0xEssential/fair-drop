...
interface ERC20PredicateProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20PredicateProxy extends Contract {
  ...
  interface: ERC20PredicateProxyInterface;
