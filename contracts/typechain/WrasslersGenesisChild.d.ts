...
interface WrasslersGenesisChildInterface extends ethers.utils.Interface {
  functions: {
    ...
    "devMint(string,string,string,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
...
export class WrasslersGenesisChild extends Contract {
  ...
  interface: WrasslersGenesisChildInterface;
  ...
  functions: {
    ...
    "devMint(string,string,string,uint256,uint256,uint256,uint256,uint256)"(
      ipfsHash: string,
      name: string,
      bio: string,
      attack: BigNumberish,
