...
interface WrasslingGenesisChildInterface extends ethers.utils.Interface {
  functions: {
...
export class WrasslingGenesisChild extends Contract {
  ...
  interface: WrasslingGenesisChildInterface;
