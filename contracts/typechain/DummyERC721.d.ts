...
interface DummyERC721Interface extends ethers.utils.Interface {
  functions: {
    ...
    "setTokenMetadata(uint256,bytes)": FunctionFragment;
...
export class DummyERC721 extends Contract {
  ...
  functions: {
    ...
    "setTokenMetadata(uint256,bytes)"(
      tokenId: BigNumberish,
      data: BytesLike,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
