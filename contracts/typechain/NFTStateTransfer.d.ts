...
interface NFTStateTransferInterface extends ethers.utils.Interface {
  functions: {
    ...
    "approvedMinters(address)": FunctionFragment;
...
export class NFTStateTransfer extends Contract {
  ...
  interface: NFTStateTransferInterface;
  ...
  approvedMinters(arg0: string, overrides?: CallOverrides): Promise<boolean>;
