...
interface ChildMintableERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class ChildMintableERC20 extends Contract {
  ...
  interface: ChildMintableERC20Interface;
