...
interface MintableERC721PredicateProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class MintableERC721PredicateProxy extends Contract {
  ...
  interface: MintableERC721PredicateProxyInterface;
