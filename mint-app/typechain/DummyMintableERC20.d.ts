...
interface DummyMintableERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class DummyMintableERC20 extends Contract {
  ...
  interface: DummyMintableERC20Interface;
