...
interface WrassleableERC721Interface extends ethers.utils.Interface {
  functions: {
...
export class WrassleableERC721 extends Contract {
  ...
  interface: WrassleableERC721Interface;
