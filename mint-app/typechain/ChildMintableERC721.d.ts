...
interface ChildMintableERC721Interface extends ethers.utils.Interface {
  functions: {
    ...
    "encodeTokenMetadata(uint256)": FunctionFragment;
    ...
    "withdrawWithMetadata(uint256)": FunctionFragment;
    "withdrawnTokens(uint256)": FunctionFragment;
  };
...
export class ChildMintableERC721 extends Contract {
  ...
  interface: ChildMintableERC721Interface;
