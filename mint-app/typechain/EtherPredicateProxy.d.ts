...
interface EtherPredicateProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class EtherPredicateProxy extends Contract {
  ...
  interface: EtherPredicateProxyInterface;
