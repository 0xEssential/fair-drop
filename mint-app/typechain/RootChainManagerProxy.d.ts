...
interface RootChainManagerProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class RootChainManagerProxy extends Contract {
  ...
  interface: RootChainManagerProxyInterface;
